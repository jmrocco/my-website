      ...
      <div class="homePage">
        <header className="home-header">
            ...
            <h2>Computer Engineering Student at</h2>
             <a id='waterlooLink' href="https://uwaterloo.ca/future-students/programs/computer-engineering"target="_blank">
        ...
        <div>
            <div class="about">
                <h1 id="welcome">Hello, nice to meet you! I'm Juliette.</h1>
